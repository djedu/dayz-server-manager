...
@Component({
    selector: 'sb-servers-cards',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './servers-cards.component.html',
    styleUrls: ['servers-cards.component.scss'],
})
export class ServersCardsComponent implements OnInit {
